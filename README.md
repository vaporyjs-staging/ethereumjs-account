...
This library eases the handling of Vapory accounts, where accounts can be either external accounts 
or contracts (see 
...
provide functionality for reading and writing accounts from and to the Vapory state trie.
